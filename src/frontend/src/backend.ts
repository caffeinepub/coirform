...
import type { Order as _Order, StripeSessionStatus as _StripeSessionStatus, Time as _Time, UserProfile as _UserProfile, UserRole as _UserRole } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async createOrder(arg0: string, arg1: string, arg2: string, arg3: string, arg4: string, arg5: string, arg6: string, arg7: string, arg8: string | null, arg9: boolean): Promise<Order> {
        if (this.processError) {
            try {
                const result = await this.actor.createOrder(arg0, arg1, arg2, arg3, arg4, arg5, arg6, arg7, to_candid_opt_n3(this._uploadFile, this._downloadFile, arg8), arg9);
    ...
    async getVibesByType(arg0: string): Promise<Array<VibeDesign>> {
        if (this.processError) {
            try {
                const result = await this.actor.getVibesByType(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async seedVibes(): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.seedVibes();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
function from_candid_record_n5(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        ...
        color: value.color,
        vibe: record_opt_to_undefined(from_candid_opt_n6(_uploadFile, _downloadFile, value.vibe)),
        aiSuggestionUsed: value.aiSuggestionUsed,
